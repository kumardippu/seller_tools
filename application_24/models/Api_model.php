   ...
   function rtsAction($rtsData=''){
       // print_r($data);exit;
        ...
        $parameters = array(
            ...
            'OrderItemIds' => "[".$rtsData['itemids']."]",
            'DeliveryType' => $rtsData['delivery_type'],//'dropship',//Dropship,Pickup,Send to Warehouse(dropship,pickup,send_to_warehouse)
            'ShippingProvider' =>$rtsData['shipping_provider'],//'Jocom Own Fleet',//LGS-FM41,LGS-FM42,LGS-FM43,Jocom Own Fleet
            'TrackingNumber' => $rtsData['tracking_no'],//'LZD4100005551334MY',
           // 'SellerShortCode'=>'MY10RW4',
    ...
    function manifestDocs($docData=''){
       // print_r($data);exit;
        ...
        $parameters = array(
            ...
            // The API method to call.
            'Action' => 'GetDocument',
            'OrderItemIds' => "[".$docData['itemids']."]",
            'DocumentType' =>'carrierManifest',
            // The format of the result.
            'Format' => 'json',
